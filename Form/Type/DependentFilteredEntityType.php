...
class DependentFilteredEntityType extends AbstractType
{
    ...
    {
        $view->vars['parent_field'] = $form->getAttribute('parent_field');
        $view->vars['entity_alias'] = $form->getAttribute('entity_alias');
        $view->vars['no_result_msg'] = $form->getAttribute('no_result_msg');
        $view->vars['empty_value'] = $form->getAttribute('empty_value');
    }
